...
> `D:\ANHDUC\ADUC_vault\ADUC\projects\pathfinder\sources\docs\context\docs\PROJECT_CONTEXT.md`
>
...
- Decision log mirror: `D:\ANHDUC\Path_finder\logs\DEV_LOG.md`

## Routing Layer
- Optional vault mirror: `D:\ANHDUC\ADUC_vault\ADUC\projects\pathfinder\README.md`
- Use the vault as a low-token navigation and synthesis layer when helpful.
- Repo docs under `docs/` remain canonical. The vault does not override repo contracts.
...
- If using the mirrored vault, navigate `README -> domain hub -> leaf note`, then return to repo docs for exact contract checks.
