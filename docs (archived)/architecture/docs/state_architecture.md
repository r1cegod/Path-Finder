...
| `job_research` | `JobResearch` | job research planner / researcher | job synthesizer | Overwritten per Stage 3 turn |
...
#### job_research â€” JobResearch
Stage 3 retrieval packet. Written between extraction and final synthesis.

Fields: `need_research`, `query_focus`, `contradiction_to_test`, `search_query`, `domain_bucket`, `evidence_summary`, `cited_sources`, `market_verdict`, `research_complete`
